...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # title header mentions to-do list
        header_text = self.browser.find_element_by_tag_name('h1').text
        self.assertIn('To-Do', header_text)

        # see enter to-do item in input box
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## of first user is coming through from cookies ect
        self.browser.quit()
        self.browser = webdriver.Chrome()

        # new user visits home page and does not see first user's list
        self.browser.get(self.live_server_url)
        ...
        # again, no trace of first user's list
        page_text = self.browser.find_element_by_tag_name('body').text
        self.assertNotIn('Buy peacock feathers', page_text)
        self.assertNotIn('make a fly', page_text)
    ...
    def test_layout_and_styling(self):
        ...
        # user notices the input box nice and centered
        inputbox = self.browser.find_element_by_id('id_new_item')
        ...
        # user inputs item and sees that the list view inputbox is centered as well
